        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearOrPeriod = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_ApprovedByAdminId",
                        column: x => x.ApprovedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_ReservedByUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Редки монети и нумизматични ценности.", "Монети" },
                    { 2, "Ретро и колекционерски часовници.", "Часовници" },
                    { 3, "Антикварни книги, албуми и издания.", "Книги" },
                    { 4, "Порцеланови сервизи, чаши и фигурки.", "Порцелан" },
                    { 5, "Исторически военни предмети и аксесоари.", "Военни артефакти" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ApprovedByAdminId",
                table: "Items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ReservedByUserId",
                table: "Items",
